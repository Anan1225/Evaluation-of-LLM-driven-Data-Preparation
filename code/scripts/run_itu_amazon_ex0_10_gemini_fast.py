...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run iTu-Amazon EM (gemini fast) for example_num=0..10 at fixed p=1.0, r_len=1.0, k=3")
    ...
    batch_dir = Path(args.out_dir) / f"batch_itu_amazon_gemini_fast_p100_r100_k3_seed{args.seed}_rep{args.repeat}_{stamp}"
    ...
    dedicated = summary_dir / f"summary_itu_amazon_gemini_fast_p100_r100_k3_seed{args.seed}_rep{args.repeat}.csv"
